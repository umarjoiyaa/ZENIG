  ...
  <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
      ...
      <a class="navbar-brand" href="index-2.html" aria-label="Front">
        <img class="navbar-brand-logo" src="{{asset('assets/img/logo.png')}}" alt="Logo" data-hs-theme-appearance="default">
        <img class="navbar-brand-logo" src="{{asset('assets/img/logo.png')}}" alt="Logo" data-hs-theme-appearance="dark">
        <img class="navbar-brand-logo-mini" src="{{asset('assets/img/logo.png')}}" alt="Logo" data-hs-theme-appearance="default">
        <img class="navbar-brand-logo-mini" src="{{asset('assets/img/logo.png')}}" alt="Logo" data-hs-theme-appearance="dark">
      </a>
      <!-- End Logo -->
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="footer">
      <div class="row justify-content-between align-items-center">
        <div class="col">
          <p class="fs-6 mb-0">&copy; Copyright {{date('Y')}} . All rights reserved IIOT FACTORY.</p>
        </div>
        <!-- End Col -->
      </div>
      <!-- End Row -->
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Mar 2024 01:20:06 GMT -->
</html>
